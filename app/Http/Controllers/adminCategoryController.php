...
class adminCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $menuPosts = 'active';
        return view('dashboard.categories.index', compact('menuPosts', 'categories'));
    }
    ...
    {
        $menuPosts = 'active';
        return view('dashboard.categories.form_add', compact('menuPosts'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('dashboard.categories.form_edit', compact('edit', 'menuPosts'));
    }
