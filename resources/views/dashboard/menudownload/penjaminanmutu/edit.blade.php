    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        <form method="POST" action="{{ route('penjaminanmutu.update', $penjaminanmutu->id) }}"
                            ...
                            <div class="mb-3">
                                <label for="filedata" class="form-label">Post File penjaminan mutu</label>
                                <input type="hidden" name="oldImage" value="{{ $penjaminanmutu->filedata }}">
                                @if ($penjaminanmutu->filedata)
                                <img src="{{ asset('storage/' . $penjaminanmutu->filedata) }}"
