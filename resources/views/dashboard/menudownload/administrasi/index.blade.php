...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Data Administrasi /</span> List
    </h4>
    <div class="row mt-3">
                            ...
                            <table class="table table-striped table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('administrasi.show', $post->id) }}"
                                                class="badge bg-info"><i class="bi bi-eye-fill"></i></a>
                                            <a href="{{ route('administrasi.edit', $post->id) }}"
                                                class="badge bg-warning"><i class="bi bi-pencil-square"></i></a>

                                            <form action="{{ route('administrasi.destroy', $post->id) }}" method="POST"
                                                class="d-inline">
                                                @method('DELETE')
                                                @csrf
