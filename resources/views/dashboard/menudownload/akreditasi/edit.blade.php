...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Edit Data Akreditas</h4>
                    ...
                    <div class="col-lg-12">
                        <form method="POST" action="{{ route('akreditasi.update', $akreditasi->id) }}" class="mt-5"
                            ...
                            <div class="mb-3">
                                ...
                                @enderror
                                <input id="body" type="hidden" name="body" value="{{ old('body', $akreditasi->body) }}">
                                <trix-editor input="body"></trix-editor>
                            </div>

                            <div class="mb-3">
                                <label for="filedata" class="form-label">Post File</label>
                                <input type="hidden" name="oldImage" value="{{ $akreditasi->filedata }}">
                                @if ($akreditasi->filedata)
                                <img src="{{ asset('storage/' . $akreditasi->filedata) }}"
