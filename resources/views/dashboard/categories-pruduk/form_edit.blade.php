                ...
                <div class="card-body">
                    <form action="{{ route('categoryproduk.update', $edit->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Input Usrname"
                                aria-describedby="defaultFormControlHelp" value="{{ $edit->name }}">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="slug" name="slug" placeholder="Input slug"
                                aria-describedby="defaultFormControlHelp" value="{{ $edit->slug }}">
