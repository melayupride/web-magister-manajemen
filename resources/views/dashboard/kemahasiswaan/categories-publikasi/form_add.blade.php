...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Add Categori Publikasi Nasional</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('categoripublik.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
