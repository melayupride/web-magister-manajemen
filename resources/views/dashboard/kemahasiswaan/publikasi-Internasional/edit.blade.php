...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Edit Data Publikasi Internasional</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <h5 class="card-header">Edit Publikasi Internasional</h5>
                    <div class="card-body">
                        <div class="col-lg-12">
                            <form method="POST" action="{{ route('publikasi-internasional.update', $lembaga->id) }}" class="mt-5"
