...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">        
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Data Publikasi Internasional /</span> List
        </h4>
        <div class="d-flex justify-content-between">
            <a href="{{ route('categoriinternasional.index') }}" class="menu-link btn btn-info btn-sm ">
                        ...
                        <div class="col-sm-12">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('publikasiinternasional.create') }}">
                                        <button class="btn btn-primary">Tambah</button>
                                    </a>
                                </div>

                                <!-- Form untuk memilih kategori -->
                                <form action="{{ route('publikasiinternasional.index') }}" method="GET">
                                    <div class="mb-3">
                                    ...
                                    <tbody>                                        
                                        @foreach ($lembaga as $post)
                                            <tr>
                                                ...
                                                <td>                                                    
                                                    <a href="{{ route('publikasiinternasional.edit', $post->id) }}"
                                                        class="badge bg-warning"><i class="bi bi-pencil-square"></i></a>

                                                    <form action="{{ route('publikasiinternasional.destroy', $post->id) }}" method="POST"
                                                        class="d-inline">
                                                        @method('DELETE')
                                                        @csrf
