...
@section('title', 'tracerstudy')
@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Tracer Study /</span> Add
    </h4>
    <div class="row">
            ...
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-12">
                        <div class="card-body">
                            <div class="col-lg-8">
                                <form method="POST" action="{{ route('tracerstudy.store') }}"
                                    ...
                                    <div class="mb-3">
                                        <label for="filedata" class="form-label">Post filel tracer study</label>
