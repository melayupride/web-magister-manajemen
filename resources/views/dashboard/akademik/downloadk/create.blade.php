...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Download Akademik /</span> Add
    </h4>
    <div class="row">
            ...
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-12">
                        <div class="card-body">
                            <div class="col-lg-8">
                                <form method="POST" action="{{ route('downloadakademik.store') }}" enctype="multipart/form-data" class="mt-5">
                                    @csrf

                                    <div class="mb-3">
                                        <label for="body" class="form-label">Download Akademik</label>
                                        @error('body')
                                    ...
                                    <div class="mb-3">
                                        <label for="filedata" class="form-label">Upload Dokumen Akademik (PDF only)</label>
