    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        <form method="POST" action="{{ route('semesterdua.update', $semester2->id) }}" class="mt-5"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="sks" name="sks" placeholder="Input SKS"
                                    aria-describedby="defaultFormControlHelp" value="{{ $semester2->sks }}">
                                @error('sks')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="oldImage" value="{{ $semester2->filedata }}">
                                @if ($semester2->filedata)
                                <img src="{{ asset('storage/' . $semester2->filedata) }}"
