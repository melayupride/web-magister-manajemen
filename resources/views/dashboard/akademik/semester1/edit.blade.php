    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        <form method="POST" action="{{ route('semestersatu.update', $semester1->id) }}" class="mt-5"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="sks" name="sks" placeholder="Input SKS"
                                    aria-describedby="defaultFormControlHelp" value="{{ $semester1->sks }}">
                                @error('sks')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="oldImage" value="{{ $semester1->filedata }}">
                                @if ($semester1->filedata)
                                <img src="{{ asset('storage/' . $semester1->filedata) }}"
