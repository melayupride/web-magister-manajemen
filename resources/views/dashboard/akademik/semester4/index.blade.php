...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Data semester4 /</span> List
    </h4>
    ...
    <div class="row mt-3">
                    ...
                    <div class="col-sm-12">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ route('semesterempat.create') }}">
                            ...
                            <table class="table table-striped table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('semesterempat.edit', $post->id) }}"
                                                class="badge bg-warning"><i class="bi bi-pencil-square"></i></a>

                                            <form action="{{ route('semesterempat.destroy', $post->id) }}" method="POST"
                                                class="d-inline">
                                                @method('DELETE')
                                                @csrf
        ...
        {{ $semester4->withQueryString()->links() }}
    </div>
</div>
@endsection
