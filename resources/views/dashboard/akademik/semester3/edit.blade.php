    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        <form method="POST" action="{{ route('semesterdua.update', $semester3->id) }}" class="mt-5"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="kodemk" name="kodemk"
                                    placeholder="Input Kode MK" aria-describedby="defaultFormControlHelp"
                                    value="{{ $semester3->kodemk }}">
                                @error('kodemk')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="sks" name="sks" placeholder="Input SKS"
                                    aria-describedby="defaultFormControlHelp" value="{{ $semester3->sks }}">
                                @error('sks')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="kontrensasi" name="kontrensasi"
                                    placeholder="Input kontrensasi" aria-describedby="defaultFormControlHelp"
                                    value="{{ $semester3->kontrensasi }}">
                                @error('kontrensasi')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="oldImage" value="{{ $semester3->filedata }}">
                                @if ($semester3->filedata)
                                <img src="{{ asset('storage/' . $semester3->filedata) }}"
