...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Edit Gambar</h4>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        <form method="POST" action="{{ route('galeriakademik.update', $galeriakademik->id) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="oldImage" value="{{ $galeriakademik->image }}">
                                @if ($galeriakademik->image)
                                <img src="{{ asset('storage/' . $galeriakademik->image) }}"
